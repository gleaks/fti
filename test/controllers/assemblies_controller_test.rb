...
class AssembliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assembly" do
    assert_difference('Assembly.count') do
      post assemblies_url, params: { assembly: { category_id: @assembly.category_id, length: @assembly.length, name: @assembly.name } }
    end
  ...
  test "should update assembly" do
    patch assembly_url(@assembly), params: { assembly: { category_id: @assembly.category_id, length: @assembly.length, name: @assembly.name } }
